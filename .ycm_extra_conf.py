...
'/gm/hpdvr/app/inc',
'-I',
'/gm/hpdvr/app/zzutils/inc',
# '--sysroot=',
# '/opt/toolchain_gnueabi-4.4.0_ARMv5TE/usr/arm-unknown-linux-uclibcgnueabi/sysroot/',
'-I',
'/opt/toolchain_gnueabi-4.4.0_ARMv5TE/usr/arm-unknown-linux-uclibcgnueabi/sysroot/usr/include',
'-isystem',
'/usr/include',
'-isystem',
'/usr/local/include',
