...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(eshell-prompt-extras esh-help auto-complete spaceline)
...
`dotspacemacs/user-config' first."
  ...
  (setq-default ispell-program-name "aspell"
                ...
                ;; ycmd-global-config "~/spacemacs-private/ycmd_global_conf.py"
                ycmd-global-config (expand-file-name "ycmd_global_conf.py" dotspacemacs-directory)
  ))
